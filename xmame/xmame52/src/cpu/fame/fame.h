...
/* Version: 2.1                                                               */
/* Date: 11-26-2006                                                           */
/* Update to emulation core by Slaanesh including efficient handling of       */
/* multiple contexts.							      */
...
void     fame68k_get_context(FAME_CONTEXT *context);
void     fame68k_set_context(const FAME_CONTEXT *context);
