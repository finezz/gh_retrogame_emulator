...
// Use new versions of ROM names?
#define NEW_CPS_XOR 1
...
ROM_START( ddsom )
	...
	ROM_REGION16_BE( CODE_SIZE, REGION_USER1, 0 )
	ROM_LOAD16_WORD_SWAP( "dd2ex.03e", 0x000000, 0x80000, 0xbdbc9b38 )
	ROM_LOAD16_WORD_SWAP( "dd2ex.04e", 0x080000, 0x80000, 0x24d1be86 )
#else
	ROM_REGION( CODE_SIZE, REGION_CPU1, 0 )      /* 68000 code */
