...
all: $(ZLIB) objdirs osdepend $(NAME).$(DISPLAY_METHOD).$(MAME_VERSION)
...
ASSEMBLER_OBJS = $(OBJ)/unix.$(DISPLAY_METHOD)/memcpy.o
...
##############################################################################
$(NAME).$(DISPLAY_METHOD).$(MAME_VERSION): $(OBJS) $(ASSEMBLER_OBJS)
	$(CC_COMMENT) @echo 'Linking $@ ...'
	$(CC_COMPILE) $(LD) $(LDFLAGS) -o $@ $(MAP) $(OBJS) $(ASSEMBLER_OBJS) $(MY_LIBS)
...
$(OBJ)/unix.$(DISPLAY_METHOD)/video-drivers/clut8to16.o: src/unix/video-drivers/clut8to16.s
	$(CC_COMMENT) @echo 'Assembling $< ...'
	$(CC_COMPILE) $(CC) $(MY_CFLAGS) -o $@ -c $<
...
doinstall:
	...
	$(INSTALL_PROGRAM) $(NAME).$(DISPLAY_METHOD).$(MAME_VERSION) $(BINDIR)

doinstallsuid:
	@echo installing binaries under $(BINDIR)...
	-$(INSTALL_PROGRAM_DIR) $(BINDIR)
	$(INSTALL_PROGRAM_SUID) $(NAME).$(DISPLAY_METHOD).$(MAME_VERSION) $(BINDIR)
