...
int m92_raster_irq_position,m92_raster_machine,m92_raster_enable;
...
{
	int offs,color,i,j,pal_base,colmask[128];
	...
	while (offs<m92_sprite_list) {
	    int x,y,sprite,x_multi,y_multi,i,j,s_ptr;
	    ...
	    color=buffered_spriteram[offs+4]&0x7f;
