...
CXX := mipsel-linux-g++
CXXFLAGS :=   -g -mips32 -ansi -W -Wno-unused-parameter -Wno-empty-body -pedantic
LD := mipsel-linux-g++
LIBS +=  -lm  -lvorbisidec  -lasound  -lz -lSDL
...
INCLUDES +=   -I/home/steward/Downloads/buildroot-2017.02.9/output/host/usr/mipsel-buildroot-linux-uclibc/sysroot/usr/include/SDL  -D_GNU_SOURCE=1 -D_REENTRANT
OBJS += 
