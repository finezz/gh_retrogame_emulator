...
#endif
#if defined(RETROGAME)
    ScreenSurface = SDL_SetVideoMode(320, 480, 16, DEFAULT_VIDEO_SURFACE_FLAG|(fullscreen_mode?SDL_FULLSCREEN:0) );
    screen_surface = SDL_CreateRGBSurface(SDL_SWSURFACE, screen_width, screen_height, screen_bpp, 0, 0, 0, 0);
#else
    screen_surface = SDL_SetVideoMode(SDL_SWSURFACE, screen_width, screen_height, DEFAULT_VIDEO_SURFACE_FLAG|(fullscreen_mode?SDL_FULLSCREEN:0) );
#endif
#ifdef BPP16
